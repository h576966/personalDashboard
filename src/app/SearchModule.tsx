  ...
  const compactBar: ReactNode = (
    <div className="flex items-center gap-1.5">
      <input
        ...
        placeholder="Search..."
        className="w-40 rounded-md border border-zinc-300 bg-white px-2.5 py-1 text-xs focus:outline-none focus:ring-2 focus:ring-teal-600 dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-100"
      />
      <button
        type="button"
        onClick={handleCompactSearch}
        disabled={!query.trim()}
        className="rounded-md bg-teal-700 px-2.5 py-1 text-xs font-medium text-white hover:bg-teal-800 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
        Go
      </button>
    </div>
